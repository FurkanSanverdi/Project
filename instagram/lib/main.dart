              ...
              child: Container(
                  ...
                  child: SingleChildScrollView(
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          storyWidget("assets/images/keyvan.jpg","keyvan_arasteh"),
                          storyWidget("assets/images/ramazan.jpg","ramazansen"),
                          storyWidget("assets/images/ahmet.jpg","ahmetselim"),
                          storyWidget("assets/images/ramazan.jpg","ramazansen"),
                          storyWidget("assets/images/keyvan.jpg","keyvan_arasteh"),
                          storyWidget("assets/images/ahmet.jpg","ahmetselim"),
                          storyWidget("assets/images/keyvan.jpg","keyvan_arasteh"),
                    ...
                    PostItem("assets/images/keyvan.jpg", "assets/images/post1.jpg","keyvan_arasteh","Turkiye"),
                    PostItem("assets/images/ahmet.jpg", "assets/images/post2.jpg","ahmetselim","Almanya"),
                    PostItem("assets/images/ramazan.jpg", "assets/images/post3.jpg","ramazan","Istanbul"),
                    PostItem("assets/images/keyvan.jpg", "assets/images/post5.jpg","keyvan_arasteh","Erzurum"),
                    PostItem("assets/images/ahmet.jpg", "assets/images/post6.jpg","ahmetselim","Ingiltere"),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              LikeCommentBox(),
              CommentBox("keyvan_arasteh","Çok iyi olmuş degerli hocam eline saglik.Miss benide etiketle. "),
              CommentBox("ramazan_sen","helal be hocam. "),
              CommentBox("furkan","elinize saglik hocam. "),
            ],
          ),
        ),
      );
